  ...
  _createClass(LightGallery, [{
    ...
    value: function refreshOnResize() {
      if (this.lgOpened) {
        ...
        this.currentImageSize = lg_utils.getSize(this.items[this.index], this.outer, top + bottom, videoInfo && this.settings.videoMaxSize);
    ...
    value: function openGallery() {
      ...
      if (this.zoomFromOrigin && element) {
        this.currentImageSize = lg_utils.getSize(element, this.outer, top + bottom, this.galleryItems[index].__slideVideoInfo && this.settings.videoMaxSize);
    ...
    value: function closeGallery(force) {
      ...
      if (this.zoomFromOrigin && currentItem) {
        ...
        var imageSize = lg_utils.getSize(currentItem, this.outer, top + bottom, this.galleryItems[this.index].__slideVideoInfo && this.settings.videoMaxSize);
